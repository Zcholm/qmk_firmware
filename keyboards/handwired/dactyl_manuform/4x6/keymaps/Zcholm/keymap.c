...
/* Home row mod-taps in control layer: */
#define MC_F5  LALT_T(KC_F5)
#define MC_F6  LSFT_T(KC_F6)
#define MC_F7  LGUI_T(KC_F7)
...
[_BASE] = LAYOUT( \
    ...
    KC_LBRC, MC_A,    MC_S,    MC_D,    MC_F,    KC_G,               KC_H,    MC_J,    MC_K,    MC_L,    MC_SCLN, KC_QUOT,   \
    KC_RBRC, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,               KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_BSLASH, \
...
[_RAISE] = LAYOUT(
    ...
    _______, _______, MC_F5,   MC_F6,   MC_F7,   KC_F8,              KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, KC_MNXT, KC_VOLU,  \
